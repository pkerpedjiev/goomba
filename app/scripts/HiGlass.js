export function RemoveHiGlassLayout(tile_info, pixiContainer) {
    function chart(function(tile)) {
         
    }
}

export function HiGlassLayout(tile_info) {
    let xScale = null;
    let height = 20;
    let resolution = tile_info.bins_per_dimension;
    let minVisibleValue = 0, maxVisibleValue =  0;
